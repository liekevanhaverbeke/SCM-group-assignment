...
OUTPUT_TOTAL = f"{FORECAST_FOLDER}/top_down_total_linear.xlsx"
OUTPUT_REGION = f"{FORECAST_FOLDER}/top_down_region_linear.xlsx"
OUTPUT_CITY = f"{FORECAST_FOLDER}/top_down_city_linear.xlsx"
OUTPUT_CITY_PRODUCT = f"{FORECAST_FOLDER}/top_down_city_product_linear.xlsx"
OUTPUT_CITY_PRODUCT_SIZE = f"{FORECAST_FOLDER}/top_down_city_product_size_linear.xlsx"
...
def run_top_down_reconciliation():
    ...
    for seg in segments:
        ...
        for city in cities:
            ...
            jaren_all = city_data['season'].tolist()
            waard_all = city_data['true_demand'].tolist()
            
            # Forecast 2026 (using data up to 2025)
            fc_2026 = lr_forecast(jaren_all, waard_all, 2026)
            ...
            if not train_val.empty:
                pred_2025 = lr_forecast(train_val['season'].tolist(), train_val['true_demand'].tolist(), 2025)
